...
#parser.add_argument('--config_file', type=str, default='configs/HandWritten_conflict.yaml') 
#parser.add_argument('--config_file', type=str, default='configs/PIE_conflict.yaml')
#parser.add_argument('--config_file', type=str, default='configs/ALOI_conflict.yaml')
...
def train_proto(args, alpha=args.base.alpha, beta=args.base.beta, gamma=args.base.gamma, margin=1):
    best_acc = 0.0
